...
public class VerificationCodePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Gill Sans", 0, 15)); // NOI18N
        jLabel1.setText("PLEASE ENTER THE VERIFICATION CODE SENT TO YOUR EMAIL:");
        ...
        jLabel2.setFont(new java.awt.Font("Gill Sans", 1, 48)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            if (code.equals(Integer.toString(id)))
            {
                dispose();
                ...
                JOptionPane.showMessageDialog(this, "The verification code is incorrect.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        accountcreationpage.setTitle("Create an account");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerificationCodePage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VerificationCodePage().setVisible(true);
            }
        });
    }
