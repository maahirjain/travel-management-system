...
public class ViewJournalPage extends javax.swing.JFrame {

    public ViewJournalPage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("VIEW JOURNAL");

        jButton1.setFont(new java.awt.Font("Gill Sans", 0, 15)); // NOI18N
        jButton1.setText("VIEW JOURNAL");
        ...
        jTable2.setFont(new java.awt.Font("Gill Sans", 0, 15)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewJournalPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewJournalPage().setVisible(true);
            }
        });
    }
